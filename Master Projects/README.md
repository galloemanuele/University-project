...
This repository contains a curated collection of my university projects developed during my Master's degree in Space Engineering.

Below is a brief overview of the most relevant projects, categorised by domain, and the main competencies acquired.


### 🪐 Astrodynamics, Navigation & Control

#### 🧭 Spacecraft Guidance and Navigation
📂 [Project Folder](./Master%20Projects/Spacecraft%20Guidance%20and%20Navigation)
**Focus:** Advanced orbit determination, state estimation, and statistical uncertainty propagation in multi-body environments.
- Multi-body dynamics uncertainty propagation (LinCov, Unscented Transform, Monte Carlo)
- Orbit determination via Non-Linear Least Squares using simulated ground station tracking
- Relative lunar navigation and state estimation leveraging an Unscented Kalman Filter (UKF)
...
- Nozzle design and performance optimization
- Injector design
...
- Payload requirement evaluation
...
- Statistical orbit determination & state estimation (UKF, LSQ)
- Propulsion system preliminary design
- Numerical optimization techniques
- Monte Carlo simulation & uncertainty quantification
- MATLAB-based modeling, SPICE Toolkit, and simulation
