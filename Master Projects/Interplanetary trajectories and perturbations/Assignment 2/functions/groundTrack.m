function [alpha,delta,lon,lat]=groundTrack(type, par, thetaG0, t_vect, mu_E, w_E)
% Function that calculates the right ascension, the declination, the
% longitude and latitude, useful for the ground track in the unperturbed 
% case.
% 
% PROTOTYPE:
%  [alpha,delta,lon,lat]=groundTrack_J2_moon(type, par, thetaG0, t_vect, mu_E, w_E)
% 
% INPUT:
...
%Integration
[T,Y] = ode113(@(t,y) ode_2bp(t,y,mu_E), t_vect, y0, options);
